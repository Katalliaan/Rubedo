...
public interface IBlockRayFilter extends IFilter<IBlockRayFilter.WorldPosition> {
	/**
	 * Check if the block ray is allowed to return this block. Note: disallowing
	 * a block will not stop the ray, a very high resistance will.
	 */
	...
	public static class WorldPosition {
		...
		public Block getBlock() {
			return this.world.getBlock(this.position.chunkPosX,
					this.position.chunkPosY, this.position.chunkPosZ);
		}
	}
}
